...
public class Ex0_main {
    public static Long ID0=207051707L;
    public static Long ID1 = 208785154L;
    public static Long ID2 = null;
    public static void main(String[] ar) {
        ...
        ElevatorAlgo ex0_alg = new SmartElev(Simulator_A.getBuilding());    // Shabat Elev with two trick - replace with your code;
